    ...
    try:
        ...
        if not activities:
            ...
            for activity in activities:
                ...
                string = u'{0}: {1}, {2}, {3}'.format(time, action, actor_name, target_name)
                return string
...
def getTargetInfo(target):
    ...
    if 'fileComment' in target:
        ...
        link = target['fileComment'].get('linkToDiscussion', 'unknown')
        return 'fileComment:"{0}, {1}"'.format(title, link)
